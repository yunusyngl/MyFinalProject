...
namespace DataAccess.Concrete.InMemory
{
    ...
    {
        List<Product> _products; // globall değişken class in içinde ama methodların dışında
        ...
        {   //LINQ -language Integrated Query
           ...
           /* Product productToDelete = null;
            ...
            Product productToDelete = _products.SingleOrDefault(p=>p.ProductId==product.ProductId);// tek bir ürünü bulmaya yarar
